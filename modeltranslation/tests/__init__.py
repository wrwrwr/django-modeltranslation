...
class ModeltranslationTest(ModeltranslationTestBase):
    ...
    def test_set_translation(self):
        ...
        self.assertEqual(inst2.title_en, '')
        ...
        with override('en'):
            ...
            self.assertEqual(inst2.title_de, '')
        ...
        self.assertEqual(inst1.title_de, '')
    ...
    def test_fallback_language(self):
        ...
        with override('en'):
            ...
            self.assertEqual(inst2.title_en, '')  # Language field access returns real value
        ...
        with default_fallback():
            ...
            with override('en'):
                self.assertEqual(inst2.title, title_de)
                self.assertEqual(inst2.title_en, '')  # Still real value
